...
export default function AddNewUserDialog() {
    ...
    return (
        <div>
            ...
            <CustomButton onClick={ handleClickOpen }>Add New User</CustomButton>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        ...
                        <p>To prevent spamming and invocations, new user create by this button will be saved in Redux store instead of Firebase's database  </p>
                        <p>Only through signup with email, new user will be save in database </p>
                    </DialogContentText>
